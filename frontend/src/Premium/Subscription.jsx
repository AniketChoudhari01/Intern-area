  ...
  useEffect(() => {
    ...
    const fetchUserPlan = async () => { 
      try {
        ...
        const response = await fetch(`http://localhost:10000/api/updatePlan?userId=${userId}`,{
          method:"GET",
          headers:{
        ...
        if (!response.ok) {
          ...
          // console.error("Error fetching subscription in reponse ok:", errorData);
          setCurrentPlan("free");
          return;
        }
    ...
    try {
      if (planName === "free") {
        ...
        const response = await fetch(
          "http://localhost:10000/api/subscription/downgrade",
          {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
      ...
      const response = await fetch(
        "http://localhost:10000/api/create-checkout-session",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
