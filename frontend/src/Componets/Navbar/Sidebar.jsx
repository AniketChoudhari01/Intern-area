      ...
      <div className="App2 -mt-2 overflow-hidden">
        ...
        <div className={`sidebar ${sidebarOpen ? "open" : ""}`}>
          ...
          <button
            ...
            className="bg-gradient-to-r from-yellow-500 to-yellow-800 text-white px-4 ml-2 py-2 rounded-full hover:from-yellow-600 hover:to-yellow-900 transition duration-200"
          >
            Premium
          </button>
        </div>
